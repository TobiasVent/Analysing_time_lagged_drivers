...
def reconstruct_one_year(year, target_mean, target_std):
    ...
    print("\n=== FIRST RAW SAMPLE ===")
    print("meta:", samples[0].meta)
    print("target (normalized):", samples[0].target)
    print("features shape:", samples[0].features.shape)
    print("features[0, :5]:", samples[0].features[0, :5])
    ...
    print("\n=== FIRST PREDICTION ===")
    print("meta:", metas[0])
    print("target_denorm:", y_denorm[0])
    print("pred_denorm:", preds_denorm[0])
